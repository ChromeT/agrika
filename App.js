...
const TKPI_DATABASE = [
  ...
  { nama: 'Beras Merah (Mentah)', kat: 'karbo', icon: 'food-variant', kalori: 352, protein: 7.5, karbo: 76.2, lemak: 1.7, serat: 3.2, mbgStatus: 'aman', mbgNotes: 'Beras merah kaya serat, sangat direkomendasikan.' },
  { nama: 'Beras Ketan Putih', kat: 'karbo', icon: 'food-variant', kalori: 362, protein: 6.7, karbo: 79.4, lemak: 0.7, serat: 0.4, mbgStatus: 'aman', mbgNotes: 'Beras ketan lokal.' },
  { nama: 'Kentang Segar', kat: 'karbo', icon: 'food-variant', kalori: 83, protein: 2.0, karbo: 19.1, lemak: 0.1, serat: 0.5, mbgStatus: 'aman', mbgNotes: 'Sumber karbohidrat segar.' },
  { nama: 'Kentang Kupas Kukus', kat: 'karbo', icon: 'food-variant', kalori: 87, protein: 1.9, karbo: 20.1, lemak: 0.1, serat: 0.6, mbgStatus: 'aman', mbgNotes: 'Kentang matang kukus.' },
  { nama: 'Singkong Segar', kat: 'karbo', icon: 'food-variant', kalori: 160, protein: 1.4, karbo: 38.1, lemak: 0.3, serat: 1.5, mbgStatus: 'aman', mbgNotes: 'Pangan lokal segar pemberdayaan petani.' },
